...
export const SAINTAL_LOGOS = {
  ...
  cookinKnowledge:
    "https://cdn.builder.io/api/v1/image/assets%2Fd83998c6a81f466db4fb83ab90c7ba25%2F766ceb5b4dea47a4a1c0d16a1a6058b2",
 ...
 * - primary: Main sidebar logo (currently in use)
 * - circuitBoard/circuitBoardSaintsal: Headers and command center
 * - goldenRobot/detailedRobot: AI-related features and tools
 * - cookinKnowledge: "Start Cookin'" feature branding
 * - brainSaint/saintVisionAI: AI companion and vision features
 * - simpleSv: Minimal contexts, favicons, small spaces
 */
